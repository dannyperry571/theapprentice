...
class InfoExtractor(object):
    ...
    def _extract_m3u8_formats(self, m3u8_url, video_id, ext=None,
        ...
        # We should try extracting formats only from main playlists [1], i.e.
        # playlists that describe available qualities. On the other hand media
        # playlists [2] should be returned as is since they contain just the media
        # without qualities renditions.
        # Fortunately, main playlist can be easily distinguished from media
        # playlist based on particular tags availability. As of [1, 2] main
        ...
        # and MUST NOT appear in main playlist thus we can clearly detect media

...
import yt
####################################PARTS TO EDIT#######################################
ADDON_NAME = 'Carrera'           ### CHANGE THIS NEW NAME OF ADDON
addon_id = 'plugin.video.Carrera' ### CHANGE THIS TO NEW FOLDER NAME - plugin.video.***   just change 'testpiece'
Base_Url = 'http://herovision.x10host.com/carrera/'   ###Change this to the location of the folder/url where you will be storing all your files, must end with /
Main_Menu_File_Name = 'main.php'    ### Change this to the name of the file that you wish to be your main menu when you open the addon in kodi
search_filenames = ['sv1','teh','s5'] ### ADD YOUR PHP FILE NAMES IN HERE TO BE INCLUDED IN SEARCHES
########################################################################################
